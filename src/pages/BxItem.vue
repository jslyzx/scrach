<template>
  <div class="bx-item mui-content-padded">
    ...
    <el-upload action="/api/upload/image" :file-list="fileList2" list-type="picture-card" :on-preview="handlePictureCardPreview" :on-success="uploadSuccess" :on-remove="handleRemove">
  ...
  methods: {
    init() {
      ...
      if (this.Image) {
        ...
        this.fileList2 = _.map(this.imgList, function(img) {
          return {
            url: that.imgurl + img
          }
        })
