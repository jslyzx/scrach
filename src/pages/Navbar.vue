<template>
    <div class="navbar">
        ...
        <section class="scroll-list">
            <panel v-for="(item,index) in sportsList" :key="item.objectId" :sport="item" v-show="initIndex == 0"></panel>
            <travel v-for="(item,index) in travelsList" :key="item.objectId" :travel="item" v-show="initIndex == 1"></travel>
        </section>
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            api.getMySport(this.userInfo.objectId)
                .then(res => {
        ...
        methods: {
            changeTab(index) {
                ...
                if(index === 0){
                    this.$route.query.type = 'sport'

                }else{
                    this.$route.query.type = 'travel'
                }
            },
            post() {
